...
async function init(){
  ...
  csvObjs.kokusei2020move = await getCsv("2020kokusei_move.csv");
  csvObjs.kokusei2020move_fromto = await getCsv("2020kokusei_move_fromto.csv");
